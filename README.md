...
Final design reference: **Solidworks 15**

All SolidWorks design images can be found under:

`Design Progress/SolidWorks`
...
https://github.com/morganwang7777-ux/Morgan-s-Metronome-v1.0
...
- **Solidworks 1** — Main enclosure
- **Solidworks 2** — PCB cavity
...
- **Solidworks 3** — Plate cavity
- **Solidworks 4** — Secondary plate slot
- **Solidworks 5** — Wiring clearance
- **Solidworks 6** — Wiring passage
...
- **Solidworks 7** — Initial retaining rail
- **Solidworks 8** — Rail design
...
- **Solidworks 9** — Initial assembly
- **Solidworks 10** — Initial rail test
- **Solidworks 11** — Rail redesign
- **Solidworks 12** — Updated assembly
- **Solidworks 13** — Final rail positions

A retaining rail movement test is also included in the SolidWorks folder.
...
- **Solidworks 14** — Mechanical stops
...
The SolidWorks assembly, design screenshots, and retaining rail motion test can all be found under:
